...
#  Uses MediaPipe Face Mesh (replaces dlib)
...
class DrowsinessDetector:
    """
    Main detector using MediaPipe Face Mesh.
    No dlib required — works on all Windows/Mac/Linux.
    """
    ...
    def process_frame(self, frame):
        ...
        Returns dict with EAR, alert flag, face_detected, annotated frame.
        """
        ...
        if result_mp.multi_face_landmarks:
            ...
            cv2.putText(result["frame"], f"L-EAR:{left_ear:.2f} R-EAR:{right_ear:.2f}",
